...
epsilon = m4_cfg.get("epsilon", 1e-3)
lambda_adv = m4_cfg.get("lambda_adv", 1.0)
epochs = m4_cfg.get("epochs", 3)
batch_size = m4_cfg.get("batch_size", 32)
learning_rate = m4_cfg.get("learning_rate", 1e-5)
